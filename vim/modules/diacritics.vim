...
if exists("b:input_method")
	...
	elseif b:input_method == "iso-8859-2" ||
		...
		call Source("~/.config/vim/modules/diacritics-iso8859-2.vim")
	elseif b:input_method == "windows-1250" ||
				\ b:input_method == "cp1250"
		call Source("~/.config/vim/modules/diacritics-windows-1250.vim")
	...
	elseif b:input_method == "utf-8" ||
				...
				\ b:input_method == "utf8" ||
				\ b:input_method == "UTF8"
		call Source("~/.config/vim/modules/diacritics-utf8.vim")
	endif
endif
